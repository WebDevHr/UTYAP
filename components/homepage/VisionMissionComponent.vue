<template>
    <div class="font-bebasneue tracking-wider select-none overflow-hidden">
      <div class="font-sans bg-transparent mx-auto max-w-7xl">
        <div class="py-4 px-6 lg:px-8 my-10 flex flex-col xl:flex-row gap-x-10 xl:h-[550px] mb-[100px] items-center">
          <div class="xl:basis-1/2 flex xl:gap-x-20 gap-x-10 justify-center items-center bg-[url('/assets/pictures/laptop.png')] bg-cover h-[180px] sm:h-[250px] xl:h-[350px] w-[296px] sm:w-[400px] xl:w-[350px]">
            <img src="/assets/pictures/gazi-logo.png" alt="Utyap Logo" class="xl:w-[120px] xl:h-[120px] sm:w-[80px] sm:h-[80px] w-[60px] h-[60px]">
